<template>
  <div data-app>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>Cierre de año</v-toolbar-title>
          <v-spacer></v-spacer>
...
import poaClosingApi from "../../apis/poaClosingApi";
...
export default {
  ...
  methods: {
    async initialize() {
      ...
      let requests = [poaClosingApi.get(), yearApi.get()];
      ...
      this.records = responses[0].data.poaClosings;
