...
@section('content')
    <div class="container">
            ...
            <p class="card-text">La evaluación consiste en la comparación de los impactos reales del proyecto con los planes estratégicos acordados. Está enfocada hacia lo que habías establecido hacer, lo que has conseguido y cómo lo has conseguido. Puede ser formativa: tiene lugar durante la vida de un proyecto u organización con la intención de mejorar la estrategia o el modo de funcionar del proyecto y organización. También puede ser conclusiva: obteniendo aprendizaje a partir de un proyecto completado o una organización que ya no está en funcionamiento. Una vez alguien describió esto como la diferencia entre un reconocimiento médico y una autopsia.</p>
